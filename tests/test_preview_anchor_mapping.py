...
class PreviewAnchorMappingTests(unittest.TestCase):
    ...
    def test_render_paginated_html_document_renders_images_and_splits_pages(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with open(tmp_path / 'test_extracted.png', 'wb') as f:
                f.write(b'\x89PNG\r\n\x1a\n')
                f.write(struct.pack('>I', 13))
                f.write(b'IHDR')
                f.write(struct.pack('>IIBBBBB', 10, 10, 8, 2, 0, 0, 0))
            ...
            entries = [
                ChapterAssemblyEntry(
                    ...
                    content=(
                        ...
                        f'![Dang nhap]({tmp_path.as_posix()}/test_extracted.png)'
                        + '{caption="Hình 1", width=80%, align=center}\n\n'
