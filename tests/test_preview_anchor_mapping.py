...
class PreviewAnchorMappingTests(unittest.TestCase):
    ...
    @patch.object(PreviewUtils, '_resolve_preview_image_src', return_value='file:///mock.png')
    def test_render_paginated_html_document_renders_images_and_splits_pages(self, mock_resolve_image):
        entries = [
