...
class PreviewAnchorMappingTests(unittest.TestCase):
    ...
    def test_render_paginated_html_document_renders_images_and_splits_pages(self, mock_resolve_preview_image_src):
        mock_resolve_preview_image_src.return_value = "file:///mock_image.png"
        entries = [
