...
class PreviewAnchorMappingTests(unittest.TestCase):
    ...
    @patch('src.core.media_downloader.MediaDownloader.get_image_dimensions')
    def test_render_paginated_html_document_renders_images_and_splits_pages(self, mock_get_image_dims, mock_exists):
        # Mock Path.exists to return True for the image path so it resolves successfully
        # even on environments where this dummy path doesn't exist.
        mock_exists.return_value = True
        mock_get_image_dims.return_value = (800, 600)
