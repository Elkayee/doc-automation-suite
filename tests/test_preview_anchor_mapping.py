...
class PreviewAnchorMappingTests(unittest.TestCase):
    ...
    @patch('src.ui.preview_utils.Path.exists')
    @patch('src.core.media_downloader.MediaDownloader.get_image_dimensions')
    def test_render_paginated_html_document_renders_images_and_splits_pages(self, mock_dim, mock_exists):
        mock_exists.return_value = True
        mock_dim.return_value = (100, 100)
        entries = [
