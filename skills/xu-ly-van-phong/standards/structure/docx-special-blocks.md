...
**Quy tắc:** Callout chỉ có một dòng mở đầu bold/italic, nội dung theo sau là thường. Không viết cả
đoạn in nghiêng.
...
Mỗi dòng kết thúc `;`, dòng cuối `.`. Cấu tạo:
`Loại VB + số hiệu + ngày + cơ quan ban hành + trích yếu`.
