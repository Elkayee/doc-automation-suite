...
**Quy tắc tuyệt đối:** Một tài liệu chỉ dùng **một font body**, không trộn Times với Arial trong
cùng văn bản.
...
**Lưu ý:** VB dài không dùng size tăng dần theo cấp heading. Tất cả heading cùng 13pt, phân cấp bằng
**màu và numbering** (xem `standards/color/`).
