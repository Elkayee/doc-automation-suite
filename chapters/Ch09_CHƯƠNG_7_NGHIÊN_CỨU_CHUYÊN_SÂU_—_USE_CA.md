...
Chương này phân tích chuyên sâu **UC07 - Quản lý Nhân sự**, tập trung vào các nghiệp vụ chính gồm thêm hồ sơ nhân viên, cấp tài khoản và phân quyền sử dụng hệ thống. Nội dung được trình bày theo đúng hướng phân tích use case, tránh đi quá sâu vào thiết kế kỹ thuật triển khai.
...
Hệ thống áp dụng phân quyền theo vai trò để bảo đảm mỗi nhóm người dùng chỉ truy cập đúng chức năng được giao.
