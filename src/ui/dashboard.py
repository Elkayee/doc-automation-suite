...
class DashboardApp:
    ...
    def _build_ui(self):
        ...
        ttk.Button(
            actions_frame, text='Mo Du An', style='Action.TButton', cursor='hand2', command=self.open_project
    ...
    def refresh_projects(self):
        ...
        if self.projects_list.size() == 0:
            self.projects_list.insert(tk.END, 'Chua co du an nao. Hay tao du an moi!')
