...
class DashboardApp:
    ...
    def _build_ui(self):
        ...
        self.empty_label = ttk.Label(
            self.list_frame,
            text='No projects found. Create a new one!',
            font=('Georgia', 11, 'italic'),
            foreground='#666666',
        )
        # Intentionally not packed yet; refresh_projects will handle it.
    ...
    def refresh_projects(self):
        ...
        if has_projects:
            ...
            self.empty_label.pack(fill='both', expand=True, pady=20)
