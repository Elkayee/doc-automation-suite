...
class DashboardApp:
    ...
    def _build_ui(self):
        ...
        ttk.Button(
            actions_frame, text='+ Tao Du An Moi', style='Action.TButton', command=self.show_create_dialog, cursor='hand2'
    ...
    def refresh_projects(self):
        ...
        if self.projects_list.size() == 0:
            self.projects_list.insert(tk.END, "Chưa có dự án nào. Hãy tạo dự án mới!")
            self.projects_list.itemconfig(0, foreground='gray', selectbackground='#f3efe5', selectforeground='gray')
    ...
    def delete_selected_project(self):
        ...
        if idx == 0 and self.projects_list.itemcget(0, 'foreground') == 'gray':
            return
