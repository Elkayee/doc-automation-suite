...
class DashboardApp:
    ...
    def _build_ui(self):
        ...
        self.empty_projects_label = ttk.Label(
            self.list_frame,
            text='No projects found. Please create a new project!',
            font=('Georgia', 12),
            foreground='#666666',
            background='#f3efe5',
            anchor='center',
        ...
        self.projects_list = tk.Listbox(self.list_frame, font=('Consolas', 11), height=10)
    ...
    def refresh_projects(self):
        ...
        if has_projects:
            self.empty_projects_label.pack_forget()
            self.projects_list.pack(fill='both', expand=True)
        else:
            self.projects_list.pack_forget()
            self.empty_projects_label.pack(fill='both', expand=True, pady=20)
